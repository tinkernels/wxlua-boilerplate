...
wget https://github.com/tinkernels/libwxlua-dist/releases/latest/download/wxWidgets-dist-macos-amd64.tar.gz

wget https://github.com/tinkernels/libwxlua-dist/releases/latest/download/wxlua-dist-macos-amd64.tar.gz
