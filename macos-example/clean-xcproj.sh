...
find . -type f -iname "contents.xcworkspacedata" -exec rm -rfv {} \;
find . -type f -iname "*.xcscmblueprint" -exec rm -rfv {} \;
find . -type f -iname "*.xccheckout" -exec rm -rfv {} \;

find . -type d -iname "xcuserdata" -exec rm -rfv {} \;